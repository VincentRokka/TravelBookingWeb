        ...
        <div class="row">
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="#">Từ khóa tìm kiếm: <?php echo $_POST['search_product']; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    while($row_search = mysqli_fetch_assoc($query_search)) {?>
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="card">
                                <img class="card-img-top" src="img/<?php echo $row_search['anh_sp'] ?>" alt="Card image cap" style="width: 200px;">
                                <div class="card-body">
                                    <h4 class="card-title show_txt"><a href="Detail.php?id_sp=<?php echo $row_search['id_sp']; ?>" title="View Product"><?php echo $row_search['ten_sp'] ?></a></h4>
                                    <p class="card-text show_txt"><?php echo $row_search['chi_tiet_sp'] ?>
                                </p>
                                <div class="row">
                                    <div class="col">
                                        <p class="btn btn-danger btn-block"><?php echo number_format($row_search['gia_sp']) ?></p>
                                    </div>
                                    <div class="col">
                                        <a href="Cart.php?id_sp=<?php echo $row_search['id_sp']; ?>" class="btn btn-success btn-block">Add to cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
